...
Call log:
  ...
  - waiting for getByText('Apple').nth(2)
...
> 17 |     await (expect(page.getByText('Apple').nth(2))).toBeVisible();
     |                                                    ^ Error: expect(locator).toBeVisible() failed
  18 |     await (expect(page.getByText('Orange'))).toBeVisible();
  19 |     await (expect(page.getByText('Banana'))).toBeVisible();
  20 |     await (expect(page.getByText('Strawberry'))).toBeVisible();
