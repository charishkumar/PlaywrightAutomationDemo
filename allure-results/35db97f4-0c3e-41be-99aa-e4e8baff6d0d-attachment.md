...
- Name: Chapter04/06_IteratingElement_Test.spec.ts >> Iterating matching Elements in Playwright
- Location: tests/Chapter04/06_IteratingElement_Test.spec.ts:3:5

# Error details

```
TypeError: elements is not iterable
```
      ...
      - generic [ref=e8]:
        ...
        - generic [ref=e13]:
          ...
          - generic [ref=e46]:
            ...
            - button "Appearance settings" [disabled] [ref=e63]:
              - img
  - main [ref=e66]:
    - generic [ref=e69]:
      - generic [ref=e70]:
...
```ts
  ...
  2  | 
  3  | test('Iterating matching Elements in Playwright', async ({page}) => {
  4  |   await page.goto('https://github.com/BakkappaN/');
  5  | 
  6  |   const elements = await page.locator('.repo").all();');
  7  |   
