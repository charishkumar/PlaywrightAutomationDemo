...
Locator: getByText('Grapes').nth(1)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Grapes').nth(1)
...
```ts
  ...
  23 | 
  24 |     await (expect(page.getByText('Apple').nth(1))).toBeVisible();
  25 |     await (expect(page.getByText('Orange').nth(1))).toBeVisible();
  26 |     await (expect(page.getByText('Banana').nth(1))).toBeVisible();
  27 |     await (expect(page.getByText('Strawberry').nth(1))).toBeVisible();
> 28 |     await (expect(page.getByText('Grapes').nth(1))).toBeVisible();
     |                                                     ^ Error: expect(locator).toBeVisible() failed
  29 | 
  30 | });
```